...
Ext.define('Ext.ux.TreePicker', {
    ...
    createPicker: function() {
        var me = this,
            picker = Ext.create('Ext.tree.Panel',Ext.applyIf({
                shrinkWrapDock: 2,
                store: me.store,
                floating: true,
    ...
    onItemexpand : function(node){
    	...
    	this.fireEvent('itemexpand',this,picker,node);
    },
    
    onBeforeitemexpand : function(node){
    	var picker = this.getPicker();
    	this.fireEvent('beforeitemexpand',this,picker,node);
    },
...
//        me.picker.hide();
    ...
    onExpand: function() {
        ...
        me.fireEvent('pickerexpand',me,picker);
    },
